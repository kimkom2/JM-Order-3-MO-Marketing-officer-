...
Mobile.delay(3)
Mobile.tap(findTestObject('Object Repository/Form Survey/Check Lingkungan/Menu Check Lingkungan 3'), 0)
Mobile.delay(2)
...
if (Hohendy.getValue('Use', baris) == 'Yes')
	{	
		...
		Mobile.delay(1)
		Mobile.tap(findTestObject('Object Repository/Form Survey/Check Lingkungan/Hubungan Pemohon/Hub ' + Hohendy.getValue('Hub Dengan pemohon3', baris)), 0, FailureHandling.OPTIONAL)
		Mobile.hideKeyboard()
