...
TestData PARAMCOUPLOAD = findTestData('Data Files/Param CO UPLOAD')

//Mobile.startExistingApplication('id.co.jmpmf.jmo3')

Mobile.delay(1)

Mobile.tap(findTestObject('Object Repository/Form Upload CO/Form Upload'), 0)
...
Mobile.setText(findTestObject('Object Repository/Form upload Menu/Telusuri'), PARAMCOUPLOAD.getValue('NO_REGISTRASI', 1), 0)
