...
def query = "exec [JMPMFI_Mobile]..MO_MAPPING_SURYEYOR_BYZIPCODE select top 1 no_registrasi,surveyor_id,crtdtm from [JMPMFI_Mobile]..mo_datasurvey where 1=1 AND CONVERT(varchar, crtdtm, 101) = CONVERT(varchar, getdate(), 101) order by crtdtm desc"
