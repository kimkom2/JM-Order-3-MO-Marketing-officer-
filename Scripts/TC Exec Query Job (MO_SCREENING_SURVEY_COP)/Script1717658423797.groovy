...
def query = "exec [JMPMFI_Mobile]..MO_SCREENING_SURVEY_COP select top 1 no_registrasi,is_surveyor from [JMPMFI_Mobile]..mo_map where 1=1 AND CONVERT(varchar, upddtm, 101) = CONVERT(varchar, getdate(), 101) order by upddtm desc"
