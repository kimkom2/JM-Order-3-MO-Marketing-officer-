...
// Tulis SQL query
def query = "exec [STAGINGR2].[dbo].Jobuntukkatalon;select top 1 prospectid from [STAGINGR2].[dbo].[STG_RCA] where  CONVERT(varchar, DtmUpd, 101) = CONVERT(varchar, getdate(), 101) ORDER BY DtmUpd DESC"
// Eksekusi query
